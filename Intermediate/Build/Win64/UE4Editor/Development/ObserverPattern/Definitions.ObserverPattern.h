...
#define UE_PROJECT_NAME ObserverPattern
#define UE_TARGET_NAME ObserverPatternEditor
#define UE_MODULE_NAME "ObserverPattern"
...
#define OBSERVERPATTERN_API DLLEXPORT
